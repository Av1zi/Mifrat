...
exports.BUILD_SLOTS = void 0;
exports.slotForCategory = slotForCategory;
exports.numAttr = numAttr;
exports.cpuSocketsForProduct = cpuSocketsForProduct;
exports.motherboardSocketsForProduct = motherboardSocketsForProduct;
exports.coolerSocketsForProduct = coolerSocketsForProduct;
exports.memoryTypeForProduct = memoryTypeForProduct;
exports.estimateWattage = estimateWattage;
exports.checkCompatibility = checkCompatibility;
exports.impliedFilterValues = impliedFilterValues;
exports.optionMatchesTokens = optionMatchesTokens;
exports.isProductCompatibleWithBuild = isProductCompatibleWithBuild;
exports.BUILD_SLOTS = [
    {
        id: "cpu",
        categories: ["cpu"],
...
function slotForCategory(category) {
    return exports.BUILD_SLOTS.find((s) => s.categories.includes(category)) ?? null;
}
/** First number found in any of the given attributes ("650W" -> 650). */
function numAttr(p, keys) {
...
const CHIPSET_TOKENS = Object.keys(CHIPSET_SOCKET).sort((a, b) => b.length - a.length);
...
function socketTokensFromText(text) {
...
function chipsetSocketFromText(text) {
...
function socketTokensFromAttributes(p, keys) {
    const values = [];
    for (const key of keys) {
...
function cpuSocketsForProduct(p) {
...
function motherboardSocketsForProduct(p) {
    const fromAttrs = socketTokensFromAttributes(p, [
        "socket",
        "cpu_socket",
        "sockets",
    ...
    if (fromChipsetAttr)
        return [fromChipsetAttr];
    const fromTextChipset = chipsetSocketFromText(`${p.name} ${p.model ?? ""}`);
    if (fromTextChipset)
        return [fromTextChipset];
    return socketTokensFromText(`${p.name} ${p.model ?? ""}`);
}
function coolerSocketsForProduct(p) {
    const fromAttrs = socketTokensFromAttributes(p, [
        "socket",
        "socket_compat",
        "sockets",
...
function memoryTypeForProduct(p) {
    const source = [
...
============================================================================
*/
function knownPartWattage(slotId, p) {
...
============================================================================
*/
function checkCompatibility(parts, estWatts, lang) {
    const issues = [];
    const cpu = parts.cpu;
...
============================================================================
*/
function impliedFilterValues(slotId, parts) {
...
function optionMatchesTokens(value, tokens) {
...
============================================================================
*/
function isProductCompatibleWithBuild(product, slotId, parts) {
    if (slotId === "cpu") {
        const motherboard = parts.motherboard;
        if (motherboard) {
            const boardSockets = motherboardSocketsForProduct(motherboard);
